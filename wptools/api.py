...
def html(title, lead=False, test=False, verbose=False,
...
def text(title, compact=False, lead=False, test=False, verbose=False,
         wiki=fetch.WPToolsFetch.ENDPOINT):
...
def wikitext(title, lead=False, test=False,
             wiki=fetch.WPToolsFetch.ENDPOINT):
